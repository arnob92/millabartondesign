      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="w-full bg-gray-100 flex items-center order-2 md:order-1">
          <div className="w-full px-8 py-12 md:px-12 lg:px-16">
            <h1 className="mb-3 leading-tight text-xl sm:text-2xl md:text-3xl lg:text-5xl pt-4 pb-4">
              Transformez votre intérieur <br />
              en un lieu qui vous ressemble.
            </h1>
            <p className="text-xs sm:text-base md:text-base lg:text-2xl mb-6 pt-4 pb-4">
